...
var BubbleTree = function(config, onHover, onUnHover) {
	...
	me.initPaper = function() {
        ...
        if (w == 0) {
            console.log('Warning: width is 0, using default value');
            w = 100;
        }
        if (h == 0) {
            console.log('Warning: height is 0, using default value');
        }
		me.width = w;
		me.height = h;
		me.paper = paper;
        ...
        if (isNaN(me.a2radBase)) {
            me.a2radBase = me.ns.a2radBase = 1;
        }
